                  ...
                  {filtered
                    ...
                    .map((p: any) => (
                      <tr key={`${p.ticker}-${p.broker}`} className="border-b border-border/50 hover:bg-muted/30">
                        ...
                        <td className={`p-4 text-right font-mono ${(p.unrealized_pnl || 0) >= 0 ? "text-green-400" : "text-red-400"}`}>
                          {(p.unrealized_pnl || 0) >= 0 ? "+" : ""}${(p.unrealized_pnl || 0).toLocaleString()}
                        </td>
                        <td className={`p-4 text-right font-mono ${(p.unrealized_pnl_pct || 0) >= 0 ? "text-green-400" : "text-red-400"}`}>
                          {(p.unrealized_pnl_pct || 0) >= 0 ? "+" : ""}{(p.unrealized_pnl_pct || 0).toFixed(1)}%
                        </td>
